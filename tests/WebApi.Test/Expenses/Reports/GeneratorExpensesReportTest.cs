...
public class GeneratorExpensesReportTest : CashFlowClassFixture
{
    ...
    public GeneratorExpensesReportTest(CustomWebApplicationFactory webApplicationFactory) : base(webApplicationFactory)
    {
