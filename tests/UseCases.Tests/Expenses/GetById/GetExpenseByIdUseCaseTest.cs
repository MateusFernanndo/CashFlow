...
public class GetExpenseByIdUseCaseTest
{
    ...
    public async Task Sucess()
    {
        ...
        result.PaymentsType.Should().Be((CashFlow.Communication.Enums.PaymentsType)expense.PaymentsType);
    ...
    private GetExpenseByIdUseCase CreateUseCase(CashFlow.Domain.Entities.User user, Expense? expense = null)
    {
