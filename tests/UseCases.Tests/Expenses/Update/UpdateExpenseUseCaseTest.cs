...
public class UpdateExpenseUseCaseTest
{
    ...
    public async Task Sucess()
    {
        ...
        expense.PaymentsType.Should().Be((CashFlow.Domain.Enums.PaymentsType)request.PaymentsType);
    }
    [Fact]
    ...
    {
        var repository = new ExpensesUpdateOnlyReposioryBuilder().GetById(user, expense).Build();
